...
namespace Checkpoints
{
    ...
    // pyrocoin: synchronized checkpoint (centrally broadcasted)
    ...
    // pyrocoin: get last synchronized checkpoint
    ...
    // pyrocoin: only descendant of current sync-checkpoint is allowed
    ...
    // pyrocoin: reset synchronized checkpoint to last hardened checkpoint
...
// pyrocoin: sync-checkpoint master key
...
// pyrocoin: verify signature of sync-checkpoint message
...
// pyrocoin: process synchronized checkpoint
