...
// pyrocoin: total coins staked (non-spendable until maturity)
...
// pyrocoin: check 'spent' consistency between wallet and txindex
// pyrocoin: fix wallet spent state according to txindex
...
// pyrocoin: disable transaction (only for coinstake)
